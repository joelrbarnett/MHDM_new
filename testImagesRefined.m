...
fileNames=["barbara","cameraman","pollen","mandril","circles","geometry","disc_square","disc_square_dark"]; 
images=["barbara.png","cameraman.tif","pollen.tif","mandril_gray.tif","circles.tif","geometry.tif","disc_square.png","disc_square_dark.png"];
imagesPNG=["barbara.png","cameraman.png","pollen.png","mandril.png","circles.png","geometry.png","disc_square.png","disc_square_dark.png"];
...
for j=[7]%1:length(images) %loop over all images
    close all;
    %filenames for saving
    filePrefix="AA_oneInit/"+fileNames(j)+"_noise_refined/";
...
%     F_data=double(F_data)+1;
    ...
    for k=1:numScales    
        ...
        uk=AAlog_blur_refined(F_data+2,xk,dt,lambda,alp,T, epsilon, maxIters);
        ...
        xkArray(:,:,1,k)=xk-2; %updated multiscale image
