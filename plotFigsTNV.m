function plotFigsTNV(F_orig, F_data, xkArray,params,T,filePrefix,figPrefix,saveFlag,tightFlag)
...
xlabel('Multiscales: k','FontSize',22)
if tightFlag(1)==1
    title(['(H(F_{data},Tx_k)+\alpha_kTV(x_k))/H(F_{data},Tu), k^*=',num2str(k_star-1)],'FontSize',22)    
else
