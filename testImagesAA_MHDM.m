...
for j=[1,2,7] %loop over all images
    close all;
    %filenames for saving
    filePrefix="AA_MHDM_blur/"+fileNames(j)+"_5/";
...
%     F_data=double(F_data);
    ...
    a=25; %gamma noise with mean 1, standard deviation 0.2., for high noise a=1 
    ...
    for k=1:numScales    
        ...
        [uk,energy]=AA_MHDM(F_data,xk,dt,lambda,T,epsilon,maxIters);
