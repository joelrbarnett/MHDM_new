...
function [xk_f_norm2,rmse_final,stopCrit,snr]= metricsTNV(F_orig,F_data,xkArray,T,numScales,tightFlag)
[m,n]=size(F_orig);
...
for k=1:numScales
    ...
    elseif tightFlag(1)==1 %stopping criteria for tight and refined versions
        ...
        stopCrit(k)= (H_f_data_Txk+ alp*TV(xkArray(:,:,k)))/(delta_2);%ratio of bregman distances
    end
