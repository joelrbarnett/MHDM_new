...
function plotZoomImagesARO(F_orig, F_data, xkArray,zoomBox,T,filePrefix,figPrefix,saveFlag,tightFlag)

numScales = length(xkArray(1,1,1,:));
[~,rmse_final,stopCrit,~]= metricsARO(F_orig,F_data,squeeze(xkArray),T,numScales,tightFlag);
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
